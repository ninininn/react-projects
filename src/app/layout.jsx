                ...
                <div id="root">
                    <div className="App">
                        <header className="App-header">
                            <h1 className='title font-bold text-dark-blue select-none text-3xl'>{activeSegment === null ? "Projects Home" : options[options.map((el) => `${el[0].toLowerCase()}` + `${el.slice(1)}`).indexOf(activeSegment)]}</h1>
